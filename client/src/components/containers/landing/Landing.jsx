...
function Landing() {
  ...
  useEffect(() => {
    ...
    const sequence = [
      ...
      ['.tel', { scale: invicons ? 1 : 0, opacity: invicons ? 1 : 0 }, { duration, delay: 0.01 }],
      ['.pin', { scale: invicons ? 1 : 0, opacity: invicons ? 1 : 0 }, { duration, delay: 0.005 }],
      ['.twi', { scale: invicons ? 1 : 0, opacity: invicons ? 1 : 0 }, { duration, delay: 0.001 }],
